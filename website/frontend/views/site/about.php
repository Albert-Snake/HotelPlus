...
<!--                <img style="width:75%; border-radius: 15px" src="/imgs/HPLogo48x48.svg">-->
            ...
            <div class="col-8 text-left">
                <h2>Quem Somos</h2>
                <p>Nós, a HotelPlus, somos uma entidade Hoteleira que entrega soluções tecnológicas dentro do nosso estabelecimento para melhorar e/ou criar um ambiente de descanso mais eficaz sem precisar de qualquer contacto com o nosso staff.</p>
                <br>
                <h4>Como o fazemos?</h4>
                <p>Tornando os nossos sistemas o mais simples possível para os utilizadores, precisando apenas que o nosso cliente crie a sua própria conta e faça uma marcação de estadia no nosso estabelecimento. No check-in será entregue um dispositivo móvel para facilitar ainda mais a sua estadia e maximizar a experiência de relaxamento apenas à distância de um clique.</p>
                <br>
                <h4>O que o Sistema permite fazer?</h4>
                <p>Através de um simples clique os nosso clientes podem aceder ao cardápio do restaurante do nosso Hotel, podem fazer uma marcação de mesa, visualizar as suas marcações e pedir uma limpeza para o seu quarto.</p>
            </div>
        </div>
    </div>
    <br>
